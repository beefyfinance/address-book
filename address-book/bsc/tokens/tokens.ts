export const tokens = {
  GARUDA: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/garudaswap_32.png",
  },
  WINGS: {
    name: "JetSwap",
    symbol: "WINGS",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/jetswap_32.png",
  },
  SDUMP: {
    name: "Space Dumpling",
    symbol: "SDUMP",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/dumplingdefi2_32.png",
  },
  SAT: {
    name: "Satisfi",
    symbol: "xSAT",
  ...
  MASH: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/marshmellowtoken_32.png?v=4",
  },
  BLZD: {
    name: "Blizzard",
    symbol: "BLZD",
  ...
  PALM: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/yieldbay_32.png",
  },
  BGO: {
    name: "Bingo Cash",
    symbol: "BGO",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/bingocash_32.png",
  },
  sBGO: {
    name: "Bingo Share",
    symbol: "sBGO",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/bingocash-share_32.png",
  },
  TNDR: {
    name: "Thunder",
    symbol: "TNDR",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/thunderswap_32.png",
  },
  SWIRL: {
    name: "Swirl Cash",
    symbol: "SWIRL",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/swirlcash_32.png",
  },
  HPS: {
    name: "Happiness",
    symbol: "HPS",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/happiness_32.png",
  },
  PMP: {
    name: "Pumpy",
    symbol: "PMP",
  ...
  NUTS: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/squirrel_32.png",
  },
  APE: {
    name: "APEcoin",
    symbol: "APE",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/apecoin_32.png?=v1",
  },
  MFRM: {
    name: "MemeFarm",
    symbol: "MFRM",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/memefarm_32.png",
  },
  SLME: {
    name: "Slime",
    symbol: "SLME",
  ...
  SOUP: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/soupfinance_32.png",
  },
  SOUPS: {
    name: "Soup Share",
    symbol: "SOUPS",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/soupshare_32.png",
  },
  1INCH: {
    name: "1INCH",
    symbol: "1INCH",
  ...
  STEAM: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/steam_32.png",
  },
  SALT: {
    name: "Salt",
    symbol: "SALT",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/saltswap_32.png",
  },
  CROW: {
    name: "Crow",
    symbol: "CROW",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/crowfinance_32.png?=v1",
  },
  RAMEN: {
    name: "Ramen",
    symbol: "RAMEN",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/ramenswap_32.png",
  },
  BREW: {
    name: "CafeSwap",
    symbol: "BREW",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/cafeswap_32.png",
  },
  MSC: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/monsterslayer_32.png?=v1",
  },
  BTS: {
    name: "Bat True Share",
    symbol: "BTS",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/boltshare_32.png",
  },
  BTD: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/batdollar-btd_32.png",
  },
  KEBAB: {
    name: "Kebab",
    symbol: "KEBAB",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/kebabfinance_32.png",
  },
  SPG: {
    name: "Sponge",
    symbol: "SPG",
    ...
    decimals: 9,
    logoURI:
      "https://bscscan.com/token/images/sponge_32.png",
  },
  SOAK: {
    name: "Soak",
    symbol: "SOAK",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/sponge-soak_32.png",
  },
  NYAS: {
    name: "NYA Share",
    symbol: "NYAS",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/nyacash-share_32.png",
  },
  MSS: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/monsterslayer-mss_32.png",
  },
  VAPOR: {
    name: "VAPOR",
    symbol: "VAPOR",
  ...
  SBDO: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/bdollar-share_32.png",
  },
  BHC: {
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/billionhappiness_32.png?v=2",
  },
  GOLD: {
    name: "NAR Ticket",
    symbol: "GOLD",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/narwhalswap-gold_32.png",
  },
  CRED: {
    name: "Street Credit",
    symbol: "CRED",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/thugs-streetcredit_32.png",
  },
  GUNS: {
    name: "Lord of War",
    symbol: "GUNS",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/thugs-guns2_32.png",
  },
  BLIQ: {
    name: "Bliquid",
    symbol: "BLIQ",
    ...
    decimals: 18,
    logoURI:
      "https://bscscan.com/token/images/bliquid_32.png",
  },
  KTN: {
    name: "Kattana",
    symbol: "KTN",
